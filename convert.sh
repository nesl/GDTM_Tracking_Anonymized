singularity run ~/sif/open-mmlab:1.0.sif python tools/convert_datasets/mot/mot2coco.py -i $HOME/data/MOT15/ -o $HOME/data/MOT15/annotations --split-train --convert-det
