...
zed_model_cfg=dict(type='LinearEncoder', in_len=135, out_len=1,
        ffn_cfg=dict(type='SLP', in_channels=256))

range_model_cfg=dict(type='LinearEncoder', in_len=128, out_len=1,
        ffn_cfg=dict(type='SLP', in_channels=256))


model_cfgs = {('zed_camera_left', 'node_1'): zed_model_cfg,
              ('zed_camera_left', 'node_2'): zed_model_cfg,
              ('zed_camera_left', 'node_3'): zed_model_cfg,
              ('zed_camera_left', 'node_4'): zed_model_cfg,
              ('range_doppler', 'node_1'): range_model_cfg,
              ('range_doppler', 'node_2'): range_model_cfg,
              ('range_doppler', 'node_3'): range_model_cfg,
              ('range_doppler', 'node_4'): range_model_cfg}

backbone_cfgs = {'zed_camera_left': backbone_cfg, 'range_doppler': range_backbone_cfg}
