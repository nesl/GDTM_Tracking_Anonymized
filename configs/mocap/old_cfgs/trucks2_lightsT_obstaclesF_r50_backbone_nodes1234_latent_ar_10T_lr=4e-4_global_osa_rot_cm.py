...
r50_backbone_cfg=dict(type='ImageBackbone')
r50_model_cfg=dict(type='SingleModalityModel', ffn_cfg=None)

model_cfgs = {('zed_camera_left', 'node_1'): r50_model_cfg,
              ('zed_camera_left', 'node_2'): r50_model_cfg,
              ('zed_camera_left', 'node_3'): r50_model_cfg,
              ('zed_camera_left', 'node_4'): r50_model_cfg}
backbone_cfgs = {'zed_camera_left': r50_backbone_cfg}
