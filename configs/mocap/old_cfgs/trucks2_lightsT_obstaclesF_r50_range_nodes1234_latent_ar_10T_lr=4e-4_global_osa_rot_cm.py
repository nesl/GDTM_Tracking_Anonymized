...
traincacher=dict(type='DataCacher',
    ...
    num_past_frames=9,
    valid_nodes=[1,2,3,4],
    valid_mods=['mocap', 'zed_camera_left_r50', 'range_doppler'],
    include_z=False,
)
...
valset=dict(type='HDF5Dataset',
    cacher_cfg=dict(type='DataCacher',
        ...
        valid_nodes=[1,2,3,4],
        valid_mods=['mocap', 'zed_camera_left_r50', 'zed_camera_left', 'range_doppler'],
        include_z=False,
        #max_len=500,
    ),
    # name='val',
...
range_model_cfg=dict(type='SingleModalityModel', ffn_cfg=None)

model_cfgs = {('range_doppler', 'node_1'): range_model_cfg,
              ('range_doppler', 'node_2'): range_model_cfg,
              ('range_doppler', 'node_3'): range_model_cfg,
              ('range_doppler', 'node_4'): range_model_cfg,
              ('zed_camera_left_r50', 'node_1'): r50_model_cfg,
              ('zed_camera_left_r50', 'node_2'): r50_model_cfg,
              ('zed_camera_left_r50', 'node_3'): r50_model_cfg,
              ('zed_camera_left_r50', 'node_4'): r50_model_cfg}
backbone_cfgs = {'zed_camera_left_r50': r50_backbone_cfg, 'range_doppler': range_backbone_cfg}
